...
const ManageCars = () => {
  ...
  const {currency, isOwner, axios} = useAppContext();
   ...
   const toggleAvailabiliy = async (carId) => {
    try {
        ...
        {cars.map((car, index)=>(
          <tr key={index} className="border-t border-borderColor">
           ...
           <td className="flex items-center p-3">
            <img onClick={() => toggleAvailabiliy(car._id)} src={car.isAvailable ? assets.eye_close_icon : assets.eye_icon} className="cursor-pointer" alt="" />
